...
export const rootTouchUpData = {
  meta: {
    title: "Root Touch-Up Services",
    subtitle: "Quick Color Refresh • Perfect Maintenance",
    backLink: "/hair-services",
    backText: "Back to Hair Services",
    ctaText: "Book Touch-Up - $65+",
    theme: "emerald" as const
  },
  hero: {
    title: "Perfect Root Maintenance",
    description: "Keep your color looking fresh with professional root touch-up services between full color appointments",
    highlight: {
      title: "Quick & Convenient",
      description: "Most root touch-ups completed in under an hour - perfect for busy schedules"
    }
  },
  serviceOptions: [
    {
